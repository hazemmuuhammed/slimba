    ...
    <>
      <View style={styles.headerContainer}>
        <View style={styles.leftIcons}>
          ...
          <TouchableOpacity onPress={handleInboxPress} style={styles.inboxIconContainer}>
            <Ionicons name="mail-outline" size={24} color={theme.colors.primaryGreen100} />
        ...
        <View style={styles.centerContainer}>
          ...
          >
            <Ionicons
              name="arrow-back"
              size={24}
              color={dates.indexOf(currentDate) >= dates.length - 1 ? theme.colors.primaryGreen20 : theme.colors.primaryGreen100}
            />
          </TouchableOpacity>
          <Text style={styles.dateText}>
            {dates.indexOf(currentDate) === 0 ? `Heute, ${formatDate(currentDate)}` : formatDate(currentDate)}
          </Text>
          <TouchableOpacity
          ...
          >
            <Ionicons
              name="arrow-forward"
              size={24}
              color={dates.indexOf(currentDate) === 0 ? theme.colors.primaryGreen20 : theme.colors.primaryGreen100}
            />
          </TouchableOpacity>
        </View>
