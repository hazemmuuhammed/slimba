...
import { View, Text, Modal, StyleSheet, TouchableOpacity, Dimensions, TouchableWithoutFeedback, Image, Alert } from 'react-native';
import { Ionicons } from '@expo/vector-icons';
import theme from '../hooks/theme';
import useStore, { MealStatus } from './store';
import { useRouter } from 'expo-router';
import MealSuggestionModal from './MealSuggestionProps';
...
const MealModal: React.FC<MealModalProps> = ({ visible, onClose, onSelection, meal, recommendations }) => {
  ...
  const handleInfoPress = () => {
    onClose();
    setTimeout(() => {
      router.push('/screens/calorieCalculator');
          ...
          <TouchableWithoutFeedback>
            <View style={styles.modalContent}>
              ...
              <View style={styles.cheatMealContainer}>
                ...
                >
                  <Image source={require('../assets/icons/burger.png')} style={styles.cheatMealIcon} />
                  <Text style={styles.cheatMealText}>{cheatMealsRemaining}</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.inspirationButton} onPress={handleInspirationPress}>
                  <Image source={require('../assets/icons/inspiration.png')} style={styles.inspirationIcon} />
                </TouchableOpacity>
                <TouchableOpacity style={styles.infoButton} onPress={handleInfoPress}>
                  <Ionicons name="help-outline" size={26} color={theme.colors.primaryGreen100} />
                </TouchableOpacity>
              </View>
              <View style={styles.spaceContainer}></View>
              <View style={styles.optionContainer}>
                <Text style={styles.optionText}>Weniger/nichts</Text>
                <TouchableOpacity style={[styles.optionButton, styles.lessButton]} onPress={() => { onSelection('Nichts gegessen'); onClose(); }}>
                  <Ionicons name="arrow-down-outline" size={24} color={theme.colors.accentOrange100} />
                </TouchableOpacity>
              </View>
              <View style={styles.optionContainer}>
                <Text style={[styles.optionText, styles.recommendationText]}>Ca. {recommendations.min} - {recommendations.max} Kalorien</Text>
                <TouchableOpacity style={[styles.optionButton, styles.recommendedButton]} onPress={() => { onSelection('Richtig gegessen'); onClose(); }}>
                  <Ionicons name="reorder-two" size={24} color={theme.colors.primaryGreen100} />
                </TouchableOpacity>
              </View>
              <View style={styles.optionContainer}>
                <Text style={styles.optionText}>Mehr</Text>
                <TouchableOpacity style={[styles.optionButton, styles.moreButton]} onPress={() => { onSelection('Zuviel gegessen'); onClose(); }}>
                  <Ionicons name="arrow-up-outline" size={24} color={theme.colors.accentRed100} />
                </TouchableOpacity>
              </View>
            </View>
          </TouchableWithoutFeedback>
      ...
      >
        <View style={styles.centeredModalContainer}>
          <View style={styles.confirmModalContent}>
            <Text style={styles.confirmModalText}>Bist du sicher, dass du dein Cheat Meal einsetzen möchtest?</Text>
            <View style={styles.confirmButtonsContainer}>
              <TouchableOpacity style={[styles.confirmButton, styles.confirmButtonYes]} onPress={handleUseCheatMeal}>
                <Text style={styles.confirmButtonText}>Ja</Text>
              </TouchableOpacity>
              <TouchableOpacity style={[styles.confirmButton, styles.confirmButtonNo]} onPress={() => setConfirmCheatMealVisible(false)}>
...
const styles = StyleSheet.create({
  ...
  modalContent: {
    ...
    position: 'relative',
    height: height * 0.50, // Updated to 50% of the screen height
  },
  closeButton: {
    position: 'absolute',
    top: 10,
