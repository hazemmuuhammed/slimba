...
export default function PersonalInfoScreen() {
  ...
  const [activityLevel, setActivityLevel] = useState(userInfo.activityLevel.toString());
  ...
  const handleSave = () => {
    ...
    if (isNaN(newWeight) || isNaN(newHeight) || isNaN(newActivityLevel)) {
      Alert.alert('Fehler', 'Bitte geben Sie gültige numerische Werte für Gewicht, Größe und Aktivitätsniveau ein.');
      return;
    }
    ...
    setUserInfo(displayName, newWeight, newHeight, birthday, newActivityLevel, goal, gender);
      ...
      <View style={styles.container}>
        <View style={styles.form}>
          ...
          <TouchableOpacity onPress={showDatePicker}>
            <Text style={[getInputStyle('birthday'), styles.birthdayInput]}>{birthday}</Text>
          </TouchableOpacity>
          <DateTimePickerModal
          ...
          {activityLevels.map((level) => (
            <TouchableOpacity
              key={level.value}
              style={[styles.activityButton, activityLevel === level.value && styles.activeButton]}
          ...
          {goals.map((g) => (
            <TouchableOpacity
              key={g.value}
              style={[styles.activityButton, goal === g.value && styles.activeButton]}
          ...
          <RNPickerSelect
            ...
            style={{
              ...pickerSelectStyles,
              inputIOS: [pickerSelectStyles.inputIOS, activeInput === 'gender' && styles.activeInput],
              inputAndroid: [pickerSelectStyles.inputAndroid, activeInput === 'gender' && styles.activeInput],
            }}
